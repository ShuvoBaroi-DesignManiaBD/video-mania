...
>(({ className, checkedChildren, uncheckedChildren, ...props }, ref) => (
  <SwitchPrimitives.Root
    ref={ref}
    className={cn(
      "group relative inline-flex h-7 w-15 shrink-0 cursor-pointer items-center rounded-full border-none data-[state=checked]:border-2 border-transparent ring-primary",
  ...
  >
    ...
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none absolute block size-6 ml-1 data-[state=unchecked]:-ml-0.5 rounded-full bg-primary shadow-md ring-0",
